...
const Pubkey spl_token_wbtc_mint_address = {{TOKEN_MINT_ADDRESS_WBTC}};
const Pubkey spl_token_link_mint_address = {{TOKEN_MINT_ADDRESS_LINK}};
const Pubkey spl_token_usde_mint_address = {{TOKEN_MINT_ADDRESS_USDE}};
const Pubkey spl_token_usds_mint_address = {{TOKEN_MINT_ADDRESS_USDS}};
const Pubkey spl_token_cbbtc_mint_address = {{TOKEN_MINT_ADDRESS_CBBTC}};
const Pubkey spl_token_susde_mint_address = {{TOKEN_MINT_ADDRESS_SUSDE}};
const Pubkey spl_token_wlfi_mint_address = {{TOKEN_MINT_ADDRESS_WLFI}};
const Pubkey spl_token_usd1_mint_address = {{TOKEN_MINT_ADDRESS_USD1}};
const Pubkey spl_token_pyusd_mint_address = {{TOKEN_MINT_ADDRESS_PYUSD}};
const Pubkey spl_token_jitosol_mint_address = {{TOKEN_MINT_ADDRESS_JITOSOL}};
const Pubkey spl_token_wsol_mint_address = {{TOKEN_MINT_ADDRESS_WSOL}};
const Pubkey spl_token_jlp_mint_address = {{TOKEN_MINT_ADDRESS_JLP}};
const Pubkey spl_token_bnsol_mint_address = {{TOKEN_MINT_ADDRESS_BNSOL}};
const Pubkey spl_token_trump_mint_address = {{TOKEN_MINT_ADDRESS_TRUMP}};
const Pubkey spl_token_pump_mint_address = {{TOKEN_MINT_ADDRESS_PUMP}};
const Pubkey spl_token_syrupusdc_mint_address = {{TOKEN_MINT_ADDRESS_SYRUPUSDC}};
const Pubkey spl_token_lbtc_mint_address = {{TOKEN_MINT_ADDRESS_LBTC}};
const Pubkey spl_token_pengu_mint_address = {{TOKEN_MINT_ADDRESS_PENGU}};
const Pubkey spl_token_render_mint_address = {{TOKEN_MINT_ADDRESS_RENDER}};
const Pubkey spl_token_solvbtc_mint_address = {{TOKEN_MINT_ADDRESS_SOLVBTC}};
const Pubkey spl_token_fdusd_mint_address = {{TOKEN_MINT_ADDRESS_FDUSD}};
const Pubkey spl_token_usdg_mint_address = {{TOKEN_MINT_ADDRESS_USDG}};
const Pubkey spl_token_virtual_mint_address = {{TOKEN_MINT_ADDRESS_VIRTUAL}};
const Pubkey spl_token_jupsol_mint_address = {{TOKEN_MINT_ADDRESS_JUPSOL}};
const Pubkey spl_token_spx_mint_address = {{TOKEN_MINT_ADDRESS_SPX}};
const Pubkey spl_token_cake_mint_address = {{TOKEN_MINT_ADDRESS_CAKE}};
const Pubkey spl_token_ousg_mint_address = {{TOKEN_MINT_ADDRESS_OUSG}};
const Pubkey spl_token_msol_mint_address = {{TOKEN_MINT_ADDRESS_MSOL}};
const Pubkey spl_token_usdy_mint_address = {{TOKEN_MINT_ADDRESS_USDY}};
const Pubkey spl_token_tbtc_mint_address = {{TOKEN_MINT_ADDRESS_TBTC}};
const Pubkey spl_token_2z_mint_address = {{TOKEN_MINT_ADDRESS_2Z}};
const Pubkey spl_token_pyth_mint_address = {{TOKEN_MINT_ADDRESS_PYTH}};
const Pubkey spl_token_wif_mint_address = {{TOKEN_MINT_ADDRESS_WIF}};
const Pubkey spl_token_hnt_mint_address = {{TOKEN_MINT_ADDRESS_HNT}};
const Pubkey spl_token_borg_mint_address = {{TOKEN_MINT_ADDRESS_BORG}};
const Pubkey spl_token_ath_mint_address = {{TOKEN_MINT_ADDRESS_ATH}};
const Pubkey spl_token_axyc_mint_address = {{TOKEN_MINT_ADDRESS_AXYC}};
const Pubkey spl_token_jto_mint_address = {{TOKEN_MINT_ADDRESS_JTO}};
const Pubkey spl_token_zbcn_mint_address = {{TOKEN_MINT_ADDRESS_ZBCN}};
const Pubkey spl_token_fluid_mint_address = {{TOKEN_MINT_ADDRESS_FLUID}};
const Pubkey spl_token_bbsol_mint_address = {{TOKEN_MINT_ADDRESS_BBSOL}};
const Pubkey spl_token_fartcoin_mint_address = {{TOKEN_MINT_ADDRESS_FARTCOIN}};
const Pubkey spl_token_lion_mint_address = {{TOKEN_MINT_ADDRESS_LION}};
const Pubkey spl_token_dsol_mint_address = {{TOKEN_MINT_ADDRESS_DSOL}};
const Pubkey spl_token_w_mint_address = {{TOKEN_MINT_ADDRESS_W}};
...
int print_spl_token_transfer_info(const SplTokenTransferInfo* info,
    ...
    item = transaction_summary_general_item();
    summary_item_set_pubkey(item, "Token Sender", info->src_account);

    item = transaction_summary_general_item();
    summary_item_set_pubkey(item, "Token Recipient", info->dest_account);
